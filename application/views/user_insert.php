...
<!-- Bootstrap -->
<link href="../../accest/_include/css/bootstrap.min.css" rel="stylesheet">

<!-- Main Style -->
<link href="../../accest/_include/css/main.css" rel="stylesheet">

<!-- Supersized -->
<link href="../../accest/_include/css/supersized.css" rel="stylesheet">
<link href="../../accest/_include/css/supersized.shutter.css" rel="stylesheet">

<!-- FancyBox -->
<link href="../../accest/_include/css/fancybox/jquery.fancybox.css" rel="stylesheet">

<!-- Font Icons -->
<link href="../../accest/_include/css/fonts.css" rel="stylesheet">

<!-- Shortcodes -->
<link href="../../accest/_include/css/shortcodes.css" rel="stylesheet">

<!-- Responsive -->
<link href="../../accest/_include/css/bootstrap-responsive.min.css" rel="stylesheet">
<link href="../../accest/_include/css/responsive.css" rel="stylesheet">
...
<!-- Modernizr -->
<script src="../../accest/_include/js/modernizr.js"></script>
                	...
                	<section id="projects">
                    	<ul id="thumbs">
                        	...
                        	<li class="item-thumbs span3 design">
                            	...
                            	<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The City" href="../../accest/_include/img/work/full/image-01-full.jpg">
                                	<span class="overlay-img"></span>
                                    <span class="overlay-img-thumb font-icon-plus"></span>
                                </a>
                                <!-- Thumb Image and Description -->
                                <img src="../../accest/_include/img/work/thumbs/image-01.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                        	<!-- End Item Project -->
                        	...
                        	<li class="item-thumbs span3 design">
                            	<!-- Fancybox - Gallery Enabled - Title - Full Image -->
                            	<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Office" href="../../accest/_include/img/work/full/image-02-full.jpg">
                                	<span class="overlay-img"></span>
                                    <span class="overlay-img-thumb font-icon-plus"></span>
                                </a>
                                <!-- Thumb Image and Description -->
                                <img src="../../accest/_include/img/work/thumbs/image-02.jpg" alt="Lorem ipsum dolor sit amet, consectetur adipiscing elit. Phasellus quis elementum odio. Curabitur pellentesque, dolor vel pharetra mollis.">
                            </li>
                        	<!-- End Item Project -->
                        	...
                        	<li class="item-thumbs span3 photography">
                            	<!-- Fancybox - Gallery Enabled - Title - Full Image -->
                            	<a class="hover-wrap fancybox" data-fancybox-group="gallery" title="The Mountains" href="../../accest/_include/img/work/full/image-03-full.jpg">
                                	<span class="overlay-img"></span>
                                    <span class="overlay-img-thumb font-icon-plus"></span>
                                </a>
                                <!-- Thumb Image and Description -->
